...
chol_med = dataset['Cholesterol'].median()

#All the rows having cholesterol value zero is replaced with the median value
dt.loc[dt['Cholesterol'] == 0, 'Cholesterol'] = chol_med
